...
<body class="help-page">
    ...
    <main class="dashboard-container">
        ...
        <section id="donor-management-section" class="dash-content-card">
           ...
           // count donations
                $donation_count_query = "SELECT COUNT(*) as total FROM screenings WHERE donor_id='$id'";
                $donation_count_result = mysqli_query($conn,$donation_count_query);
                $donation_count = mysqli_fetch_assoc($donation_count_result)['total'];
    ...
    <footer>
        <div class="footer-container">
            ...
            <div class="footer-links">
                ...
                <a href="staff-notifications.html">Notifications</a>
